// assets/icons/Coins.tsx

import { FC } from 'react';
import { IconProps } from '@/types';

const Coins: FC<IconProps> = ({ size = 24, className = '' }) => {

	const svgSize = `${ size }px`;

	return (
		<svg fill="currentColor" className={ className } height={ svgSize } width={ svgSize } viewBox="0 0 512 512"
